...
class RegistrationForm(FlaskForm):
    ...
    description = StringField("Description", [validators.DataRequired(message="Please enter a descrtiption")])
    category = StringField("Description", [validators.DataRequired(
